            ...
            if request.method == 'POST':
                ...
                if request.form['action'] == 'login':
                    ...
                    if UsuarioDB and valid_pw(request.form['form-email']
                        ...
                        return render_template('inicio.htm',username=login_session ['sesion-nombre'] ,sesion_usuario=login_session ['sesion-usuario'])


                    else:
                        error = "Usuario o clave, incorrecta ingrese una correcta"
...
def logout():
    ...
    print ('logout')
    if 'sesion-usuario' in login_session:
        del login_session ['sesion-usuario'] 
...
def inicio():
    ...
    if 'sesion-usuario' not in login_session:
        ...
        return render_template('inicio.htm', sesion_usuario=login_session ['sesion-usuario'])
            ...
            if request.form['action'] == 'registrar':
                ...
                if not UsuarioDB:
                    ...
                    if usuario_clave != usuario_clave2:
                        ...
                        #return redirect(url_for('login', message ='Se ha registrado correctamente'))
                        return render_template('login.htm', message ='Se ha registrado correctamente')
                else:
...
def editarCursoNodo():
    ...
    if request.method == 'GET':
        ...
        if request.method == 'POST':
            ...
            # if cursoNodoDB:
            #     # if (cursoNodoDB.cuno_prof_id != request.form['form-profesor']):
            #     #     actualizacion = True
                    
            #     # else:
            #     #     error = "Ya existe un curso para este nodo, año y profesor"
            #     #     return render_template('error.htm', error = error)
            # else:
...
def finInscripcion():
    ...
    if request.method == 'GET':
        ...
        if request.method == 'POST':
            ...
            return render_template('inicio.htm', message = 'Fin de la inscipción')
